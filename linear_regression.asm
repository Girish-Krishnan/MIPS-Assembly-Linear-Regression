...
line1:          .space 512                  # First line storage (x-values)
line2:          .space 512                  # Second line storage (y-values)
.align 2                                  # Ensure word alignment for float storage
x_vals:         .space 512                   # Array to store floats from the first line (x-values)
.align 2
y_vals:         .space 512                   # Array to store floats from the second line (y-values)
...
iterations:     .word 100000                # Number of SGD iterations
